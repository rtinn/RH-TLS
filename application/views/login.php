...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/images/background/bg1.jpg);">
            ...
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                 ...
                 <div class="form-check">
                     <input type="checkbox" name="remember" class="form-check-input checkko" id="remember-me">
                     <label class="form-check-label" for="remember-me">Restez connecté</label>
                 </div>                     
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-success btn-login btn-block text-uppercase waves-effect waves-light" type="submit">Connexion</button>
                        </div>
                    </div>
                </form>
            </div>
