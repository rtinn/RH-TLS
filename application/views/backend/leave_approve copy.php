    ...
    <div class="modal-dialog modal-view">
        ...
        <div class="info_row">
            ...
            <div class="row" >
                ...
                <div class="col-sm-3" id="solde_container" >
                    <label class="control-label" style="position:relative; top:7px;">Solde conge:</label>
              </div>
                <div class="col-sm-3" id="solde_container1">
        ...
        container.fadeOut(300, function () {
            container.remove();
                ...
                if (response.typeid === "Avec solde") {
                    ...
                    $('#solde_container').show();
                    $('#solde_container1').show();
                    $('#nouveau_solde').show();
                    $('#nouveau_solde1').show();
              ...
              //controle pour activtion et desactivation sur validation de RH
               
                    if($('#status_n').val() === 'Rejeté'){
                        $('#n_coms').show();
                        $('#par').show();
                        $('#status_n').prop('disabled', true);
                        $('#coms_n').prop('disabled', true);
                        $('#savenn').hide();
                    ...
                    if($('#status_rh').val() === 'Rejeté'){
                        ...
                        $('#nouveau_solde1').hide();
                        $('#nouveau_solde').hide();
                        $('#status_rh').prop('disabled', true);
                        $('#coms_rh').prop('disabled', true);
                        $('#savess').hide();
                        
                    } else if($('#status_rh').val() === 'Approuvé'){
                        $('#rh_coms').hide();
                        $('#nouveau_solde1').hide();
                        $('#nouveau_solde').hide();
                        $('#status_rh').prop('disabled', true);
                        $('#coms_rh').prop('disabled', false);
                        $('#savess').hide();
                    } else{
                        $('#rh_coms').hide();
                        $('#status_rh').prop('disabled', false);
                        $('#coms_rh').prop('disabled', false);
                        $('#savess').show();
                    }
