                       ...
                       <!--
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Personnels </span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo base_url(); ?>employee/shift"> <i class="fa fa-circle-o"></i> Shift</a></li>
                                <!--   <li><a href="<?php echo base_url(); ?>employee/Planning"> <i class="fa fa-circle-o"></i> Planning Personnels </a></li>--> 
                               
                                
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url(); ?>employee/pointage" aria-expanded="false"><i class="fa fa-qrcode" aria-hidden="true"></i><span class="hide-menu">Pointage </span></a></li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url(); ?>employee/timing" aria-expanded="false"><i class="fa fa-clock-o" aria-hidden="true"></i><span class="hide-menu">Timing </span></a></li>
