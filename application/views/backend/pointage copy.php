             ...
             <div id="cercle_row">
                ...
                <div id="cercle"></div>
                    ...
                    <div>
                     ...
                     <table id="tbpointage" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        <tr>
            <th>N°</th>
            <th>Poste</th>
...
$(document).ready(function() {
    ...
    var table = $('#tbpointage').DataTable();
