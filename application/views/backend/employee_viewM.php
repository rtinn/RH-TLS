                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab" style="font-size: 14px;"> Infos 1  </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab" style="font-size: 14px;"> Infos 2 </a> </li>
                            ...
                            <div class="card-body"> <small class="text-muted">Addresse E-mail </small>
                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a>
                                                ...
                                                <div class="tin">
				                                    ...
				                                    <div class="form-group col-md-2 m-t-10" >
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="gender" value="<?php echo $basic->em_gender; ?>" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> minlength="3" required> 
                                                    ...
                                                    <div class="form-group col-md-3 m-t-10">
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="nat" value="<?php echo $basic->nation; ?>" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> minlength="3" > 
				                                    
                                                            <?php } else { ?> 
                                                                <input type="text" id="example-email2" name="nat" class="form-control" placeholder="" value="<?php echo $basic->nation; ?>" > 
                                                            <?php } ?>
                                                    ...
                                                    <div class="form-group col-md-2 m-t-10" <?php if($this->session->userdata('user_type') == 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1') { ?> style="display: none;" <?php } ?>>
                                                            <label>Situation</label>

                                                            <?php if($this->session->userdata('user_type') == 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1') { ?>
                                                                <!-- Champ caché pour EMPLOYEE et N+1 -->
                                                                <input type="hidden" name="sit" value="<?php echo $basic->situation; ?>">
                                                            <?php } else { ?>
                                                                <!-- Dropdown visible pour les autres utilisateurs -->
                                                                <select name="sit" class="form-control custom-select" required>
                                                                    <option value="<?php echo $basic->status; ?>"><?php echo $basic->situation; ?></option>
				                                        ...
				                                        <input type="text" class="form-control" placeholder="" name="contact" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>  <?php } ?> value="<?php echo $basic->em_phone; ?>" minlength="10" maxlength="15" > 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Email </label>
				                                        <input type="email" id="example-email2" name="email" class="form-control" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>  <?php } ?> value="<?php echo $basic->em_email; ?>" placeholder="email@mail.com" minlength="7" > 
				                                    </div>
                                                    ...
                                                    <div class="form-group col-md-3 m-t-10">
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="lieuu" value="<?php echo $basic->lieu_naiss; ?>" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> minlength="3" > 
				                                    
                                                            <?php } else { ?> 
                                                                <input type="text" id="example-email2" name="lieuu" class="form-control" placeholder="" value="<?php echo $basic->lieu_naiss; ?>" > 
                                                            <?php } ?>
				                                    ...
				                                    <div class="form-group col-md-2 m-t-10">
				                                        <label>CIN</label>
				                                        <input type="text" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>  <?php } ?> class="form-control"placeholder="CIN" name="nid" value="<?php echo $basic->em_nid; ?>" minlength="10" > 
				                                    </div>
                                                    ...
                                                    <div class="form-group col-md-3 m-t-10">
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="lieu11" value="<?php echo $basic->lieu_cin; ?>"  > 
				                                    
                                                            <?php } else { ?> 
                                                                <input type="text" id="example-email2" name="lieu11" class="form-control" placeholder="" value="<?php echo $basic->lieu_cin; ?>" > 
                                                            <?php } ?>
                                                    ...
                                                    <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                        ...
                                                        <input type="text" class="form-control form-control-line"  name="dept" value="<?php echo $basic->dep_id; ?>" readonly > 
                                                    <?php } else { ?>
                                            ...
                                            <?php endforeach; ?>
                                                   ...
                                                   <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> 
                                                    <input type="text" class="form-control form-control-line"  name="deg" value="<?php echo $basic->des_id; ?>" readonly > 
                                            ...
                                            <?php endforeach; ?>
                                                    ...
                                                    <div class="form-group col-md-2 m-t-10">
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="contrat" value="<?php echo $basic->contrat; ?>" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> minlength="3" required> 
                                                    ...
                                                    <div class="form-group col-md-2 m-t-10" <?php if($this->session->userdata('user_type') == 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1') { ?> style="display: none;" <?php } ?>>
                                                            ...
                                                            <?php if($this->session->userdata('user_type') == 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1') { ?>
                                                                <!-- Champ caché pour EMPLOYEE et N+1 -->
                                                                <input type="hidden" name="status" value="<?php echo $basic->status; ?>">
                                                            <?php } else { ?>
                                                                <!-- Dropdown visible pour les autres utilisateurs -->
                                                    ...
                                                    <script>
                                                        document.addEventListener("DOMContentLoaded", function () {
                                                            ...
                                                            function calculateAnciennete() {
                                                                ...
                                                                if (months > 0) {
                                                                    result += (result ? ", " : "") + months + (months === 1 ? " mois" : " mois");
                                                                }

                                                                ancienneteInput.value = result || "0 mois";
                                                            }

                                                            joindateInput.addEventListener("change", calculateAnciennete);

                                                            // Calcul initial si la date est déjà remplie
                                                            calculateAnciennete();
                                                        });
                                                    </script>
                                                    ...
                                                    <div class="form-group col-md-2 m-t-10">
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="cat" value="<?php echo $basic->categorie; ?>" readonly > 
				                                    
                                                            <?php } else { ?> 
                                                                <input type="text" id="example-email2" name="cat" class="form-control" placeholder="" value="<?php echo $basic->categorie; ?>" > 
                                                            <?php } ?>
				                                    </div>
                                                    <div class="form-group col-md-2 m-t-10">
				                                        <label>Groupe </label>
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="gp" value="<?php echo $basic->groupe; ?>" readonly > 
				                                    
                                                            <?php } else { ?> 
                                                                <input type="text" id="example-email2" name="gp" class="form-control" placeholder="" value="<?php echo $basic->groupe; ?>" > 
                                                            <?php } ?>
                                                    ...
                                                    <div class="form-group col-md-2 m-t-10">
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="cnap" value="<?php echo $basic->n_cnaps; ?>" readonly > 
				                                    
                                                            <?php } else { ?> 
                                                                <input type="text" id="example-email2" name="cnap" class="form-control" placeholder="" value="<?php echo $basic->n_cnaps; ?>" > 
                                                            <?php } ?>
                                                    ...
                                                    <div class="form-group col-md-2 m-t-10">
                                                        ...
                                                        <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>
                                                            ...
                                                            <input type="text" class="form-control form-control-line"  name="hcp" value="<?php echo $basic->handycap; ?>" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> minlength="3" > 
				                                    
                                                            <?php } else { ?> 
                                                                <select name="hcp"  value="<?php echo $basic->contrat; ?>" class="form-control custom-select">
                                                            <option value="<?php echo $basic->handycap; ?>">
                                                            <?php echo $basic->handycap; ?></option>
                                   ...
                                   <?php if(!empty($basic->em_image)){ ?>
                                    ...
                                    <?php } ?>
                                                        <label>Image </label>
                                                        <input type="file" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?>  <?php } ?> name="image_url" class="form-control" value=""> 
                                                    </div>
                                ...
                                <div class="tab-pane" id="profile" role="tabpanel">
                                    <div class="card">
				                        <div class="card-body">
			                                ...
			                                <form class="row" action="Parent" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12 m-t-5">
                                                                <label>Nom et prenoms du père</label>
                                                                <input type="text" name="pere" class="form-control form-control-line" placeholder="" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> value="<?php if(!empty($basic->pere)) echo $basic->pere ?>" minlength="2" > 
                                                            </div>
                                                            <div class="form-group col-md-12 m-t-5">
                                                                <label>Nom et prenoms du mère</label>
                                                                <input type="text" name="mere" class="form-control form-control-line" placeholder="" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> value="<?php if(!empty($basic->mere)) echo $basic->mere ?>" minlength="2" > 
                                                            </div>
                                                 ...
                                                 <div class="col-sm-4">
                                                    ...
                                                    <div class="card">
                                                                <div class="card-header">
                                                                    Nom et contact  des personne en cas d'urgence 
                                                                </div>
                                                            <div class="card-body">
                                                        
                                                                <div class="form-group col-md-12 m-t-5">
                                                                    <label>Nom et prenoms</label>
                                                                    <input type="text" name="nom_ur" class="form-control form-control-line" placeholder="" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> value="<?php if(!empty($basic->nom_ur)) echo $basic->nom_ur ?>" minlength="2" > 
                                                                </div>
                                                                <div class="form-group col-md-12 m-t-5">
                                                                    <label>Contact</label>
                                                                    <input type="text" name="contact_ur" class="form-control form-control-line" placeholder="" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> value="<?php if(!empty($basic->contact_ur)) echo $basic->contact_ur ?>" minlength="2" > 
                                                                </div>
                                                            <div class="form-group col-md-12 m-t-5">
                                                                <label>Adresse</label>
                                                                <input type="text" name="adresse_ur" class="form-control form-control-line" placeholder="" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> value="<?php if(!empty($basic->adresse_ur)) echo $basic->adresse_ur ?>" minlength="2" > 
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12 m-t-5">
                                                                <label>Nom du coinjoint(e)</label>
                                                                <input type="text" name="conjoint" class="form-control form-control-line" placeholder="" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> value="<?php if(!empty($basic->conjoint)) echo $basic->conjoint ?>" minlength="2" > 
                                                            </div>
                                                            <div class="form-group col-md-12 m-t-5">
                                                                <label>Contact</label>
                                                                <input type="text" name="contact_ur" class="form-control form-control-line" placeholder="" <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> value="<?php if(!empty($basic->contact_ur)) echo $basic->contact_ur ?>" minlength="2" > 
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <?php } ?>                                                   
                                                    <button <?php if($this->session->userdata('user_type')== 'EMPLOYEE' || $this->session->userdata('user_type') == 'N+1'){ ?> readonly <?php } ?> type="submit" style="float: right" class="btn btn-success">Add Salary</button>
                                                </div>
                                                <?php } ?>
                                            </div>                                                		                                    
			                                    </form>
