...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Congé validé</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Accueil</a></li>
                <li class="breadcrumb-item active">Congé validé</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">   Liste des congé validé                     
                        </h4>
                    </div>
                    <div class="card-body">
...
<div class="modal fade reussimodal" id="reussimodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            if (em_id !== "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.nb_jour) {
                            $('#total').text('Solde du congé : ' + data.nb_jour);
                        }
                    }
    ...
    // Fonction pour récupérer le total de congé
    function fetchLeaveTotal1() {
        var em_id = $('#em_id').val();
        if (em_id !== "") {
            $.ajax({
                type: 'POST',
