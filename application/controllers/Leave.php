...
//mise à jour de st_emp apres click notifications d'acceptation de conger par n+1
    public function updateStEmp() {
        if ($this->session->userdata('user_login_access') == 1) {
            $id_conge = $this->input->post('id_conge');
    
            // Assurez-vous de bien récupérer le modèle nécessaire
            $this->leave_model->updateStEmpTo2($id_conge);
 ...
 //mise à jour de st_emp apres click notifications d'acceptation de conger par RH   
    public function updateStAdmin() {
        if ($this->session->userdata('user_login_access') == 1) {
            $id_conge = $this->input->post('id_conge');
            $this->leave_model->updateStAdminTo2($id_conge);
            ...
            <tr style="vertical-align: top">
                ...
                <?php 
                    if ($value->leave_status == "En attente" && $value->leave_status_rh == "En attente") {
                        echo '<td class="conge"><img src="'         . base_url('assets/images/waiti.png') . '" ><span class="d-none">wait</span></td>';
                    } else if($value->leave_status == "Approuvé" && $value->leave_status_rh == "En attente") {
                        echo '<td class="conge"><img src="'         . base_url('assets/images/wait_rh.png') . '" ><span class="d-none">enT</span></td>';
                    }else if ($value->leave_status == "Rejeté" && $value->leave_status_rh == "En attente") {
                        echo '<td class="conge"><img src="'         . base_url('assets/images/rejete_n.png') . '" ><span class="d-none">wait</span></td>';
                    }else if ($value->leave_status == "Approuvé" && $value->leave_status_rh == "Approuvé") {
                        echo '<td class="conge"><img src="'         . base_url('assets/images/valide.png') . '" ><span class="d-none">Vr</span></td>';
                   
                    }else{ 
                        echo '<td class="conge"><img src="'         . base_url('assets/images/rejete.png') . '" ><span class="d-none">rj</span></td>';
                    }
                    ?>
...
public function UpdateLeaveMaladie($ids, $retenu) {
    ...
    public function GetEmApplication() {
        ...
        foreach ($data['application'] as $value) { // Itérez sur les demandes de congé (supposons que les demandes de congé sont dans $data['application'])
            ...
            <tr style="vertical-align: top">
                ...
                <?php 
                    if ($value->leave_status == "En attente" && $value->leave_status_rh == "En attente") {
                        echo '<td class="conge"><img src="'         . base_url('assets/images/waiti.png') . '" ><span class="d-none">enT</span></td>';
                    } else if($value->leave_status == "Approuvé" && $value->leave_status_rh == "En attente") {
                        echo '<td class="conge"><img src="'         . base_url('assets/images/wait_rh.png') . '" ><span class="d-none">enT</span></td>';
                    }else if ($value->leave_status == "Rejeté" && $value->leave_status_rh == "En attente") {
                        echo '<td class="conge"><img src="'         . base_url('assets/images/rejete_n.png') . '" ><span class="d-none">rj</span></td>';
                    }else if ($value->leave_status == "Approuvé" && $value->leave_status_rh == "Approuvé") {
                        echo '<td class="conge"><img src="'         . base_url('assets/images/valide.png') . '" ><span class="d-none">Vr</span></td>';
    ...
    public function GetNApplication() {
        ...
        $emid = $this->session->userdata('user_login_id');
        $data['application'] = $this->leave_model->GetNallApplication($emid);
        $output = array();
